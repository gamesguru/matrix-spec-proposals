...
- **Custom PDU formats/room versions:** To allow for testing of radical or unstable features (e.g., experimental state resolution engines or customized PDU formats) where strict PDU format adherence is not possible, custom room version suffixes MAY be appended:
