...
```json
{
  "types": ["m.room.create", "uk.half-shot.hookshot.github.*"],
...
The client-facing state filter above is also complementary to
[Issue #2019](https://github.com/matrix-org/matrix-spec/issues/2019), which
motivates selecting multiple state event types without transferring unrelated
room state.
