...
and should be used where possible._
...
a good thing to list here._

_If you're having troubles coming up with a description, a good question to ask is "how
does this proposal improve Matrix?" - the answer could reveal a small impact, and that is okay._
...
a template. Afterwards, it goes on to cover the specifics of what the template could look like._
...
_Think about how to attack your proposal. See [RFC 3552](https://datatracker.ietf.org/doc/html/rfc3552)
...
_Some proposals may have some security aspect to them that was addressed in the proposed solution. This
